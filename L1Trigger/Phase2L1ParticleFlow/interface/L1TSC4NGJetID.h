...
public:
  ...
  typedef std::array<ap_ufixed<24, 12, AP_RND, AP_SAT, 0>, l1ct::JetTagClassHandler::NTagFields> classtype;
  ...
  typedef std::array<l1ct::jet_tag_score_t,l1ct::JetTagClassHandler::NTagFields> output_class_type;
